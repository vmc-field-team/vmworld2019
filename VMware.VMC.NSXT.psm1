Function Connect-NSXTProxy {
    ...
    #>
        ...
        If (-Not $global:DefaultVMCServers.IsConnected) { Write-error "No valid VMC Connection found, please use the Connect-VMC to connect"; break } Else {
            ...
            Write-host -ForegroundColor Green "Connecting to $SDDCName on $OrgName"
            $sddc = Get-VMCSDDC -Name $SDDCName -Org $OrgName
    ...
    #>
        Param (
            ...
            [Parameter(Mandatory=$False)][string]$DestinationGroup,
            ...
            [Parameter(Mandatory=$false)][string]$DestinationInfraGroup,
